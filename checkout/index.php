...
<html lang="en">
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="as" id="as" class="form-control" placeholder="Atas nama" autocomplete="off">
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="card-body">
                            <form id="formOrder" action="placeOrder.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ID_user" value="<?= "1"; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="">as</label>
                                    <input type="text" class="form-control" name="as" id="asHasil">
                                </div>
                            </form>
                        </div>
                    </div>
	...
	<script type="text/javascript">
        ...
        $("#simpanAlamat").click(function(){
            ...
            var atasNama = $("#as").val().toString();
            $("#alamatHasil").val(alamat);
            $("#asHasil").val(atasNama);
        })

        $("#order").click(function(){
            var isiAlamat = $("#alamat").val();
            var atasNama = $("#as").val();
            if(isiAlamat == "" && atasNama == ""){
